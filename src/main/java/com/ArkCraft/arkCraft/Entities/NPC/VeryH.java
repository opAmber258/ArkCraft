...
public class VeryH extends PathfinderMob {
    ...
    public VeryH(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
        this.setPersistenceRequired(); // 防止NPC消失
        // 手动初始化生命值（兜底，避免属性未加载）
        this.setHealth(this.getMaxHealth());
        this.setCustomName(Component.literal("铁头"));
    ...
    protected void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(0, new LookAtPlayerGoal(this, Player.class,
                10.0F));
